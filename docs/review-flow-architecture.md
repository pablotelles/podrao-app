...
export type ReviewCategory = 'food' | 'service' | 'ambience' | 'value' | 'cleanliness';
```
...
**Fase 1 — Domínio + Migrations** _(sem breaking change)_
...
**Fase 4 — Gamificação** _(pode ser deferred)_
